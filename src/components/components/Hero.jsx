...
const Hero = () => {
  return (
    <section className="relative w-full h-screen flex justify-center overflow-x-hidden items-center">
      <div
        className={`${styles.paddingX} flex flex-row justify-center items-center gap-5 mt-[8rem] sm:mt-0`}
      >
        <div className="select-none flex flex-col justify-center items-center gap-5 mt-[20%] ">
          <h1
